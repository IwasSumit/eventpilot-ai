  ...
  try {
    ...
    const scoredActivities = ACTIVITIES.map(activity => {
      ...
      const queueWait     = queue ? predictQueueWait({
        ...
        serviceRate: 5, activeCounters: 2,
      ...
      return { ...activity, score: activityScore,
...
Respond with JSON — NO startTime or endTime fields:
{ "activities": [{ "activityId":"", "activityName":"", "zone":"", "order":1, "estimatedWait":0, "estimatedDuration":0, "confidence":0, "crowdWarning":"", "score":0, "whyNow":"" }], "totalTime":0, "reasoning":"" }`
    ...
    try {
      ...
      parsed = { activities: top5, totalTime: timeBudgetMinutes, reasoning: agentResponse.text }
    }
    ...
    return NextResponse.json({ sessionId, itinerary: parsed,
